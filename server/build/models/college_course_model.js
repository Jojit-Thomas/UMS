...
const collegeCourseSchema = new mongoose_1.default.Schema({
    _id: {
...
exports.departmentModel = mongoose_1.default.model("departmentModel", collegeCourseSchema, constants_1.DEPARTMENT_COLLECTION);
